openerp.autocomplete_google_maps = function (instance, local) {
    "use strict";

    var core = instance.web.core;
    var form_widgets = instance.Widget;
    ...
    local.FieldCharGooglePlaces = instance.web.form.FieldChar.extend({
        template: 'autocomplete_google_maps.FieldGooglePlaces',
        ...
        gmaps_initialize: function () {
            var self = this;
            this.places_autocomplete = new google.maps.places.Autocomplete(this.$el.find('input').get(0), {
                types: ['geocode']
            });
     ...
     instance.web.form.widgets.add('google_places', 'instance.autocomplete_google_maps.FieldCharGooglePlaces');

     return local.FieldCharGooglePlaces
};
