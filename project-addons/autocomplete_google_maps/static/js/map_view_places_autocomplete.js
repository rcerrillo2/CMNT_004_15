openerp.web.MapViewPlacesAutocomplete = function (instance, local) {
    'use strict';
    ...
    local.MapPlacesAutocomplete = instance.Widget.extend({
        events: {
    ...
    return {
        'MapPlacesAutocomplete': local.MapPlacesAutocomplete,
